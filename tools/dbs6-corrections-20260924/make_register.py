...
OUT = '/home/user/PPC-Audit-/docs/DBS6_Bids_Placements_Corrections_20260921-dbcd48b8.docx'
...
r = fp.add_run('DBS6 · run 20260921-dbcd48b8 · corrections against "Bids and placements on Exact campaigns" · page ')
...
def camp(sub):
    return next(a for a in O if a['name'].startswith('DBS6-SP-' + sub))
