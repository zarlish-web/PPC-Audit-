...
bullet('**When we are there, we perform.** B4 at top of search: “bamboo sheets” CTR 3.4% vs a 1.9% bar, CVR 12.7% vs 8.3%; “queen size” 3.2% / 27% vs 1.8% / 13%; “king size” 6.7% / 16.5% vs 1.9% / 10.8%. A performance problem would show as sub-bar CTR or CVR on a decent sample; it doesn’t. One caution: across the whole product, CVR fell from 11.9% to 10.0% in the deal while CPC rose to $3.39 and ACoS reached 46.7% against a 33.9% break-even (7-day attribution understates the latest days). The deal is the velocity condition the push rests on, so product-level CVR is read daily with it.')
bullet('**The real performance gap is narrow:** “cooling sheets” (CVR 7.1% vs an 8.7% bar, ACoS 78%, rank 55 → 64 on the 7-day median) — the broad cooling head term, where a bamboo sheet is not the category’s natural answer and Bedsure sells at $59.99 with 64,900 reviews. More bid there buys more of the same shortfall. The size-qualified cooling terms (“cooling sheets queen”, “king cooling sheets”) meet the bars and are traffic gaps.')
bullet('**The tuning worked against rank.** From July to the week before the deal the rounds took B4’s ad clicks from 401 to 235 a day and orders from 46 to 28. They improved the placement mix — mostly by cutting product pages — but top-of-search clicks fell too (97 → 84 a day). Rank follows the volume of converting clicks: Bamboo drifted 31 → 35, Bamboo|Queen 32 → 44 (7-day medians). The deal round is the first that bought volume, and the one group given real top-of-search volume (Bamboo|King) moved 31 → 26 (daily low 22).')
bullet('**A minor factor: our own 6-piece bids on the same terms.** 1,242 of B4’s search terms (81% of its keyword spend) are also bought by the 6-piece. On “bamboo sheets” it took 48 top-of-search clicks in the deal against B4’s 379, so it explains a small part of the lost share at most; taking it off the top of search on B4’s ranking terms is cheap and the next-day share read settles it (D8).')
lead('What changes.', 'Buy the traffic where it performs (most in-focus terms): step the top-of-search price every day of the deal by the delivery gap, inside the loss stop and the envelope (Part A), lift budgets where they cap, and watch top-of-search impression share rise with it — that is the proof the price is working. Where impression share does not respond to price, the constraint is not price (budget cut-off, a sibling ASIN winning the auction, or eligibility) and the fix is there. Hold price and fix the offer only on the terms with a genuine CTR/CVR shortfall. Take the 6-piece off the top of search on the terms B4 is ranking. Details and the per-keyword call follow.')
...
lead('B4.', 'Through August and early September every round took volume out: ad clicks fell from 401 a day (late June/July) to 328 and then 235, orders from 46 a day to 28. The placement mix moved the right way (top of search from 26% to 37% of all clicks), but top-of-search clicks themselves fell from 97 to 84 a day — the mix improved because product pages were cut harder than top of search grew. Rank drifted (7-day medians): Bamboo 31 → 35, Bamboo|Queen 32 → 44. The deal round (15/16 Sep) is the first that bought volume: the effective top-of-search bid rose from $4.30 to $5.51, top-of-search clicks from 84 to 150 a day — and the one group given real top-of-search volume moved: Bamboo|King went 31 → 26 on the 7-day median inside the deal (daily low 22 on the 21st). Bamboo (34) and Bamboo|Queen (44) did not, and those are the ones still at 3% and under 1–3% impression share. The deal also lowered product-level CVR (11.9% → 10.0%) and lifted ACoS to 46.7% — part of that is attribution lag, but it is watched daily because the deal is what the push rests on.')
...
for kw, txt in [
    ('bamboo sheets', 'Traffic gap. Converts at 12.7% at the top (bar 8.3%), CTR 3.4% (bar 1.9%); 3.2% impression share at $7.42 and a budget used at 127% over the last 7 days. The deal doubled its top-of-search clicks (25 → 47 a day) and rank is moving slowly (7-day median 38 → 33 over the deal week): 331 a week is still two-thirds of the 490 the plan needs. Raise the budget with the step (it caps before the day ends — impression share counts the hours we are out). The delivery-gap step (+30%) takes it to $9.65: at a 12.9% top-of-search conversion a top-of-search order then costs about $75, one step short of its loss stop ($10.47 — 3× its $27.09 contribution). Past that, more share has to come from budget hours, the 6-piece stepping back, or a better conversion — not from price.'),
    ('bamboo sheets queen size', 'Traffic gap, the widest: 22 clicks a week against 248; CVR 27% at the top. Impression share 2.8% at $6.69 — and this campaign is on dynamic up-and-down bidding, which paid $11.99 a top-of-search click in the deal on a written $6.69 (A-section). Switch to fixed bids starting near the $11.99 dynamic actually paid (not $6.69 plus a step, which would halve its bid); at its 23% top-of-search conversion that is about $52 a top-of-search order, inside the stop. Budget is at 102%, lift it with the step.'),
    ('bamboo sheets king size', 'Traffic gap: 16 a week against 298, 0.6% impression share at $4.96 — the lowest effective bid of the three hero terms and the lowest share. Organic 15, sponsored 19. The step is +30% (1% of its requirement delivered) to $6.45 — about $37 a top-of-search order at its 17.5% conversion; this is the cheapest volume on the list. Its share fell in the deal (0.6% → 0.3%) with no raise, so it has not been given price yet.'),
    ('cooling sheets', 'Performance gap on CVR (7.1% vs 8.7%) with ACoS 78% and rank 55 → 64 on the 7-day median; 76% of our traffic on this term is paid. Do not add bid. The Cooling group’s market limit is the lowest in the product ($3.61) because the term converts poorly for us. Fix the offer for this query first (cooling claim in the first image and title, price against Bedsure’s $59.99) and re-test on a small probe; keep “bamboo cooling sheets”, which meets both bars, as the cooling entry point.'),
    ('bamboo sheets queen', 'Not present: 3 top-of-search clicks in 30 days, impression share 0% at $3.75 — the price is below anything that wins the top. Rank fell 29 → 71. Eligibility and price: this row needs the delivery-gap step from a floor near the group’s clearing price ($6.39), not +30% of $3.75.'),
    ...
    ('king size bamboo sheets set', 'One of the few targets above 10% impression share (15% at $9.33 effective); 3.4 top-of-search clicks a day in the deal, CVR 26% at the top — its campaign is now at its own click requirement (114%), so it takes no step and moves to cost-per-click evaluation after the deal. It is the proof on this account that price buys share (15% → 20% in the deal).'),
]:
    bullet(f'**{kw}** — {txt}')
...
bullet('**Our own second ASIN (minor).** The 6-piece bids on 1,242 of B4’s terms, but on “bamboo sheets” it took 48 top-of-search clicks in the deal against B4’s 379 — if B4 loses 95 auctions in 100, the sibling accounts for a small part at most. Whether Amazon admits two of our ASINs to the same auction is not confirmed here. Test: when the 6-piece steps back on a term (D8), B4’s share on it should rise.')
...
lead('What is happening.', f'{len(both):,} of B4’s search terms are also bought by the Decolure 6-piece — ${sum(k4[k]["spend"] for k in both):,.0f} of B4’s 30-day keyword spend (81%). B4’s run prices every term as if the 6-piece were not in the auction. On the hero term it is a small presence (48 top-of-search clicks in the deal against B4’s 379), so this is a minor cause and a cheap test, not the main answer.')
...
section('What to do')
for b in [
    '**B4, in the deal (to 09-28):** push every in-focus exact ranking campaign on top of search daily by the delivery gap (Part A), inside the loss stop (3× contribution per top-of-search order) and the envelope, with the budget raised where it caps. Read impression share and clicks every morning; share rising with price = keep stepping; share flat after a step = halve the next step and check budget hours out, the sibling ASIN and eligibility.',
    '**B4 hero terms:** “bamboo sheets” +30% to $9.65 (one step short of its $10.47 loss stop), “bamboo sheets queen size” to fixed near $11.99, “bamboo sheets king size” +30% to $6.45, budget +30% where it caps; each is graded on share and top-of-search clicks against the plan (490 / 248 / 298 a week). Rows at 0–0.1% share (“bamboo sheets queen”, “queen bamboo sheet set”) are reset to the group’s clearing price before stepping.',
