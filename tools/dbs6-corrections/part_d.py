...
lead('Short answer.', 'For B6 it is a **traffic gap** first — part of it made by the tuning, and the larger part (the late-August drop) unexplained until the console’s change history is pulled. On B6’s main ranking keywords, top-of-search clicks beat the app’s CTR bar (1.1× market) and CVR bar (3× market) wherever there is enough sample — but B6 wins almost none of the top-of-search auctions, and its ad traffic was cut by two-thirds over the last month. Rank has fallen on every tracked group as the traffic went.')
...
bullet('**When we are there, we perform.** “bamboo sheets” top-of-search CTR 3.0% vs a 1.9% bar, CVR 18.8% vs 8.3%; “queen size” 5.9% / 32.8% vs 1.8% / 13.3%; “viscose bamboo sheets” 4.6% / 23.4%. B6 converts better at the top than B4 on the same head term (18.8% vs 12.7%). The syntax-level estimate shows B6’s King, Queen and Full groups under the 3× CVR bar, but that is a split estimate on 5–13 orders; measured at campaign level over 90 days they convert at 23%, 22.5% and 21% at the top, well above their bars (D.4).')
bullet('**The traffic went, partly through the tuning.** Ad clicks fell from 310 a day (late June–July) to 265, 197 and then 101 in the last 8 days; orders from 45 to 13 a day. The logged rounds account for the later step — the 11 September round cut ranking spend in half and top-of-search clicks by a quarter. The larger drop, about 350 to 114 clicks a day between 26 August and 5 September, has no logged decision behind it (D.2). ACoS improved (29% → 24%) because B6 was buying less. Every tracked group lost rank: Bamboo 21 → 31, Bamboo|King 20 → 28, Bamboo|Queen 18 → 39 (7-day medians, June → 22 Sep).')
...
lead('Reading it.', 'The Bamboo group — two-thirds of B6’s spend — meets both bars at top of search at 2–3% impression share: a traffic gap. Bamboo|King, Bamboo|Queen and Bamboo|Full read under the 3× CVR bar in this table, but that CVR is estimated from each keyword’s campaigns’ placement split on 5–13 orders. Measured directly on the campaigns’ own placement reports over 90 days, top of search converts at 23.3% on Bamboo|King (276 orders on 1,187 clicks), 22.5% on Bamboo|Queen and 21.1% on Bamboo|Full — above every bar (10.8%, 13.3%, 12.2%). They are traffic gaps too, and the push in Part A stands. The cooling groups are barely bought (under $1,000 in 30 days across all of them) and stay out of focus.')
...
for kw, txt in [
    ...
    ('bamboo sheets king size', 'Traffic gap: 4 a week against 170; 0.6% impression share at $4.80; rank 15 → 36. Its campaign “Bamboo Sheets King Size-(HSV)” went dark after the 11 September round left it at a $0.50 base with an 860% modifier ($4.80 at the top). The +30% step to $6.24 cannot be carried by the modifier (it would need 1,148%), so the base carries it: base $0.50 → $0.62, modifier 900% — above its pre-cut $0.54, because at the new price the wall needs it. About $23 a top-of-search order at its 27% top-of-search conversion.'),
    ('bamboo sheets full', 'The proof that price buys share on B6: impression share 1.2% → 17.7% in the last 8 days at $6.50 (organic 19, sponsored 7). Its rank climb (58 → 12) came earlier in the summer, before that jump; whether the new share moves rank is the read to make. 18% of its requirement delivered → +30%; its modifier is already high after the 11 September round, so the next step will need the base to carry it (900% wall, Part A). Keep stepping while share rises.'),
...
section('What to do')
for b in [
    '**From 09-24:** push every in-focus exact ranking campaign on top of search daily by the delivery gap (Part A), inside the loss stop (3× contribution per top-of-search order) and the $619-a-day envelope; restore the bases the 11 September round cut on the campaigns that went dark, in the same write. Read impression share and clicks every morning; share flat after a step = halve the next step and check the base, the 4-piece on the same term, and eligibility.',
    '**Hero terms:** “bamboo sheets” (flagship, +15% to $7.01 with its pre-cut base restored), “bamboo sheets full” (+30% — the term already showing that price buys share), “bamboo sheets king size” (restore, then push). Budget is not the constraint on B6 — the flagship uses 16% of its budget.',
