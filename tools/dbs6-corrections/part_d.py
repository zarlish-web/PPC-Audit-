...
bullet('**The plan and the focus disagree.** B6’s plan asks for 307 clicks a week on “bamboo sheets queen size” and 1,301 a week across ten cooling terms, but neither Bamboo|Queen nor any cooling group is in focus — the in-focus groups are Bamboo, Bamboo|King, Bamboo|Full and Bamboo|California King. Those requirements have no campaign pushing them.')
...
for kw, txt in [
    ...
    ('bamboo sheets queen size', 'Traffic gap: 9 clicks a week against the plan’s 307; CVR 32.8% at the top; impression share 0.4% at $4.56; sponsored position 4 on the ASINsight sample, organic 36. But Bamboo|Queen is not in B6’s focus, so no campaign is pushing it. Decide: bring Bamboo|Queen into focus and push it (it converts better than anything else B6 buys), or take the 307 clicks out of the plan.'),
    ...
    ('bamboo cooling sheets / cooling sheets', 'Not present: 1 top-of-search click a week on “bamboo cooling sheets” against 142 planned; “cooling sheets” (460 planned, organic 78) is barely bought at all. No cooling group is in focus. Decide with Queen: bring cooling into focus with its own campaigns, or remove the 1,301 weekly cooling clicks from the plan.'),
]:
    bullet(f'**{kw}** — {txt}')
...
lead('Decision.', 'B6 keeps its terms (operator 2026-09-23): no top-of-search cut on the shared terms. Note that B4’s corrections document currently tells the 6-piece to set top of search to 0% on B4’s ranking terms for the deal — one of the two documents has to change so the listings do not get opposite instructions. Read both listings’ impression share on the shared hero terms daily: if both fall when both push, each is taking the other’s auctions.')
...
rows = [
    ...
    ['Queen and cooling exact — plan terms with no campaign in focus', 'Not in the run', '“bamboo sheets queen size” (307 clicks/wk planned, CVR 32.8%) and ten cooling terms (1,301/wk planned) have no in-focus campaign.', 'Decide focus first (D.1); if in, build the exact ranking campaigns; if out, take them out of the plan.'],
...
for b in [
    ...
    '**Decide the plan/focus mismatch:** Bamboo|Queen (307 clicks/wk planned, the best converter B6 has) and cooling (1,301/wk planned) — in focus with campaigns, or out of the plan.',
    ...
    '**Shared terms with B4:** B6 keeps them; read both listings’ share daily, and reconcile with B4’s document, which still tells the 6-piece to step back.',
