...
bullet('**When we are there, we perform.** At the top of search over 30 days: Bamboo|Cooling CTR 5.2% vs a 2.1% bar and CVR 21.4% vs 7.5%; “bamboo cooling sheets” 3.5% / 19.5% on 54 clicks. Bamboo|California King: CTR and CVR both well over the bars (CVR 25.6% vs 8.8%) — but on only 35 top-of-search clicks in 30 days across the whole group, so the call rests on a thin sample.')
...
lead('Reading it.', 'Every Bamboo group and every size-qualified Cooling group meets its CTR and CVR bars at top of search at low single-digit impression share — a traffic gap. The broad Cooling group sits at its CVR bar (8.8% vs 8.7%), held down by its head term “cooling sheets” (7.5%). The two in-focus groups: Bamboo|Cooling is a clean traffic gap on a real sample (92 top-of-search clicks, CVR 21.4% vs 7.5%); Bamboo|California King meets both bars on a thin sample (35 clicks) and is small in absolute terms — $298 in 30 days across the group.')
...
for kw, txt in [
    ...
    ('cal king bamboo sheet set / california king bamboo sheets / bamboo california king sheets', 'Already at 7–11 on the 7-day median with 2–4 top-of-search clicks in 30 days. The target (1–5) is a few positions away, and the push can buy it: grade on impression share and rank. The Cal King group converts 8.4% at the top, so its loss stops sit near $7: “cal king bamboo sheet set” is already above its stop at $10.35 (15% share, no order on 9 clicks) and holds there. “bamboo california king sheets” has had no top-of-search order on 15 clicks — under the framework’s blend that is no evidence yet, so it prices on the Cal King group rate (8.4%) and steps like the rest.'),
