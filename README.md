...
**Linen, delivered to PPC 9 September.** The pack went to Joseph: the change loader plan on the standard template carrying all 1,810 rows, plus two upload files — 1,139 update rows and 374 SP tranche A creates. 297 rows stay in the plan unuploaded behind their gates. Awaiting the upload result, an SD bulk export, and the 16 and 23 September checks.
